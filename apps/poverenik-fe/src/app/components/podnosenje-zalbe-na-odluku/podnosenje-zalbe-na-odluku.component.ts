...
export class PodnosenjeZalbeNaOdlukuComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.imeZalioca = localStorage.getItem('ime_zalioca');
    this.prezimeZalioca = localStorage.getItem('prezime_zalioca');
  ...
  prikaziXonomy() {
    ...
    let xmlString = `<?xml version="1.0" encoding="UTF-8"?><zalba_na_odluku xmlns="http://ftn.uns.ac.rs/zalba_na_odluku" about="http://www.ftn.uns.ac.rs/rdf/examples/zalba_na_odluku/${this.brojZalbe}" vocab="http://www.ftn.uns.ac.rs/rdf/examples/predicate/"><osnovni_podaci><podaci_o_zaliocu> <korisnik_email datatype="xs:string" property="pred:korisnik">${this.email}</korisnik_email><zalioc_ime datatype="xs:string" property="pred:ime_zalioca">${this.imeZalioca}</zalioc_ime><zalioc_prezime datatype="xs:string" property="pred:prezime_zalioca">${this.prezimeZalioca}</zalioc_prezime><zalioc_naziv_zalbe datatype="xs:string" property="pred:naziv_zalbe"></zalioc_naziv_zalbe><zalioc_adresa datatype="xs:string" property="pred:adresa_zalioca"></zalioc_adresa><zalioc_sediste datatype="xs:string" property="pred:sediste_zalioca"></zalioc_sediste></podaci_o_zaliocu><podaci_o_organu><naziv datatype="xs:string" property="pred:naziv_organa"></naziv></podaci_o_organu></osnovni_podaci><sadrzaj><broj_zalbe datatype="xs:integer" property="pred:broj_zalbe"></broj_zalbe><godina_zalbe datatype="xs:string" property="pred:godina_zalbe"></godina_zalbe><datum_odbijenog_zahteva datatype="xs:string" property="pred:datum_odbijenog_zahteva"></datum_odbijenog_zahteva><odluka_organa_vlasti datatype="xs:string" property="pred:odluka"></odluka_organa_vlasti></sadrzaj><podnozje><mesto_zakljucka_zalbe datatype="xs:string" property="pred:mesto_zakljucka_zalbe"></mesto_zakljucka_zalbe><datum_zakljucka_zalbe datatype="xs:string" property="pred:datum_zakljucka_zalbe">${new Date().toISOString().slice(0, 10)}</datum_zakljucka_zalbe><podaci_o_zaliocu><zalioc_ime datatype="xs:string" property="pred:ime_zalioca"></zalioc_ime><zalioc_prezime datatype="xs:string" property="pred:prezime_zalioca"></zalioc_prezime><zalioc_adresa datatype="xs:string" property="pred:adresa_zalioca"></zalioc_adresa><drugi_podaci_za_kontakt datatype="xs:string" property="pred:kontakt_zalioca"></drugi_podaci_za_kontakt><potpis_zalioca datatype="xs:string" property="pred:potpis_zalioca"></potpis_zalioca></podaci_o_zaliocu></podnozje><broj_zahteva datatype="xs:string" property="pred:broj_zahteva">${this.brojZahteva}</broj_zahteva></zalba_na_odluku>`;
