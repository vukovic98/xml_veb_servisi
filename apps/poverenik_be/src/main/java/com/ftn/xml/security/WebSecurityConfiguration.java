...
import com.ftn.xml.security.auth.RestAuthenticationEntryPoint;
import com.ftn.xml.security.auth.TokenAuthenticationFilter;
import com.ftn.xml.security.auth.TokenAuthenticationProvider;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.GET, "/zalbaCutanje" , "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
				"/**/*.css", "/**/*.js","/v2/api-docs");
	}
}